...
const music_list = [
    {
        ...
        music : 'Wave To Earth - Seasons (Lyrics).mp3'
    },
    {
        img : 'bad.jpg',
        name : 'Bad',
        artist : 'Wave To Earth',
        music : 'wave to earth - bad (Official Lyric Video).mp3'
    },
    {
        img : 'fts.jpg',
        name : 'From The Start',
        artist : 'Laufey',
        music : '@laufey - From The Start (Lyrics).mp3'
    },  
    {
        img : 'Drawer.jpg',
        name : 'Drawer',
        artist : '10CM',
        music : '10CM (십센치) - Drawer (서랍) Our Beloved Summer OST Part 1 (그 해 우리는 OST) Lyrics_가사 [Han_Rom_Eng].mp3'
    },
    {
        img : 'arbitrary.jpg',
        name : 'Arbitrary',
        artist : 'Over October',
        music : 'Over October - Arbitrary (Lyric Video).mp3'
    },
    {
        img : 'maybe.jpg',
        name : 'Maybe We Could Be A Thing',
        artist : 'Jesse Barrera',
        music : 'Jesse Barrera, Michael Carreon, Albert Posis - _Maybe We Could Be a Thing_ (Lyric Video).mp3'
    }
